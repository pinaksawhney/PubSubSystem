...
class TemperatureSensor
{
	...
	***************************************************************************/
	...
	static private void PostTemperature(MessageManagerInterface ei, float temperature )
	{
		...
		try
		{
			ei.SendMessage( msg, "Temperature" );
	...
	static private void SubscribeTemperature( MessageManagerInterface ei )
	{
		try
		{
			Vector<MessageQueue> mq = ei.GetMessageQueue();
			for (MessageQueue messageQueue : mq) {
				ei.Subscribe(messageQueue, "Temperature");
			}
