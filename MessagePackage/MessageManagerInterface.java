...
public class MessageManagerInterface
{
	...
	****************************************************************************/
	...
	public void SendMessage( Message evt, String topic ) throws ParticipantNotRegisteredException, SendMessageException
	{
		if (ParticipantId != -1)
		{
		   	try
	...
	public long Subscribe(MessageQueue mq, String topic) throws ParticipantNotRegisteredException, SendMessageException
	{
		if (ParticipantId != -1)
		{
			try
			{
				em.Subscribe( mq, topic );
				return mq.GetId();
			...
			{
				throw new SendMessageException( "Error ssubscribing to topic" + topic );
	...
	****************************************************************************/
	...
	public Vector<MessageQueue> GetMessageQueue() throws ParticipantNotRegisteredException, GetMessageException
	{
		Vector<MessageQueue> eq = null;
	...
	****************************************************************************/
	...
	public void UnSubscribe(long id, String topic) throws ParticipantNotRegisteredException, RegistrationException
	{
		if (ParticipantId != -1)
		{
			try
			{
				em.UnSubscribe(id, topic);

			} // try

			catch (Exception e)
			{
				throw new RegistrationException( "Error unsubscribing to topic" + e );
