...
class HumiditySensor
{
	...
	public static void main(String args[])
	{
		...
		Vector<MessageQueue> eq = null;				// Message Queue
		...
		if (em != null)
		{
			...
			*********************************************************************/
			...
			while ( !Done )
			{
				...
				for (int j = 0; eq!= null && j < eq.size(); j++) {
	...
	***************************************************************************/
	...
	static private void SubscribeHumidity( MessageManagerInterface ei )
	{
		try
		{
			Vector<MessageQueue> mq = ei.GetMessageQueue();
			for (MessageQueue messageQueue : mq) {
				ei.Subscribe(messageQueue, "Humidity");
			}
		...
		{
			System.out.println( "Error Subscribing to topic " + e );
